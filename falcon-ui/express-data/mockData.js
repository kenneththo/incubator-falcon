...
(function () {
  ...
  var entitiesList = {
    ...
    feed: {
      "entity":[
        {"type":"FEED","name":"feedOne","status":"SUBMITTED","tags":{"tag":["externalSystem=USWestEmailServers","classification=secure"]}},
        {"type":"FEED","name":"feedTwo","status":"RUNNING","tags":{"tag":["owner=USMarketing","classification=Secure","externalSource=USProdEmailServers","externalTarget=BITools"]}},
        {"type":"FEED","name":"feedTree","status":"SUBMITTED","tags":{"tag":["externalSystem=USWestEmailServers","classification=secure"]}},
    ...
    dataset:{"entity":[
      {"type":"dataset","name":"datasetOne","status":"SUBMITTED","tags":{"tag":["pipeline=churnAnalysisDataPipeline","owner=ETLGroup","montevideo=mvd"]}},
      {"type":"dataset","name":"datasetTwo","status":"SUBMITTED","tags":{"tag":["pipeline=churnAnalysisDataPipeline","owner=ETLGroup","externalSystem=USWestEmailServers"]}},
      {"type":"dataset","name":"datasetTree","status":"SUBMITTED","tags":{"tag":["pipeline=churnAnalysisDataPipeline","owner=ETLGroup","montevideo=mvd"]}},
      {"type":"dataset","name":"datasetFour","status":"SUBMITTED","tags":{"tag":["pipeline=churnAnalysisDataPipeline","owner=ETLGroup","externalSystem=USWestEmailServers"]}}]
    }
  },
    definitions = {
      CLUSTER: {
